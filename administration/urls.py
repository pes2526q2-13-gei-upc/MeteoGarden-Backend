...
urlpatterns = [
    ...
    path("missions/create/submit/", views.mission_create_submit, name="adm_mission_create_submit"),
    path("missions/<str:name>/edit/", views.mission_edit, name="adm_mission_edit"),
    path("missions/<str:name>/edit/submit/", views.mission_edit_submit, name="adm_mission_edit_submit"),
    ...
    path("products/create/submit/", views.product_create_submit, name="adm_product_create_submit"),
    path("products/<str:name>/edit/", views.product_edit, name="adm_product_edit"),
    path("products/<str:name>/edit/submit/", views.product_edit_submit, name="adm_product_edit_submit"),
