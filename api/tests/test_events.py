...
class EventTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.c1 = EventsCategory.objects.create(
            id=1,
            name="Música"
        )

        self.c2 = EventsCategory.objects.create(
            id=2,
            name="Turisme"
        )
    ...
    def test_get_all_events_returns_expected(self):
        ...
        from api.views.views_event import (
            get_all_events
        )

        with patch(
            "api.views.views_event.translate_text",
            side_effect=lambda xs, lang: xs
        ):
