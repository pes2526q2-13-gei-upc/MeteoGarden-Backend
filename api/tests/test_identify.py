...
class TestIdentifyPlantAPI(
    ...
    @patch(
        "api.views.views_identify.update_photo_missions"
    )
    @patch(
        "api.views.views_identify.Inventory.addSeed"
    )
    @patch(
        "api.views.views_identify.getInfoPlant"
    )
    @patch(
        "api.views.views_identify.requests.post"
    )
    @patch(
        "api.views.views_identify.os.getenv"
    )
