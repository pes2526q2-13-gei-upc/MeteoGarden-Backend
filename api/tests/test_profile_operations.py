...
from api.models import User, Garden, Inventory, Pot
...
class AuthTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.register_url = reverse('register')  # Asegúrate de que este sea el 'name' en urls.py
    ...
    def test_login_success(self):
        # Primero registramos
        User.objects.create_user(username="testuser", password="testpassword123", email="a@a.com")
    ...
    def test_get_profile_authenticated(self):
        ...
        user = User.objects.create_user(username="juanjo", password="password", email="j@j.com")
