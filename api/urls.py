...
urlpatterns = [
    ...
    path("events/city", get_events_by_city, name="events_by_city"),
    path("events/category", get_events_by_category, name="events_by_category"),
    ...
    path("friends/likes/<str:username>/", likeFriend, name="like_friend"),
]
