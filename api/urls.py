...
from .views import (assignMission, avatar, buy_item, collect_plant,
                    createMission, current_weather, delete_plant,
                    delete_profile, edit_profile, garden_plants, get_profile,
                    get_shop, get_stations, getMissions, getUserAlbum,
                    getUserAvatar, getUserMissions, google_register,
                    google_verify, health, identifyPlant, importPlant, login,
                    plant_seed, plant_status, register, saveAvatar, translate,
                    use_product, user_gardens, user_products, user_seeds,
                    validate_token, water_plant)
