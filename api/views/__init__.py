...
from .views_profile_operations import (edit_profile, get_profile,
                                       google_register, google_verify, login,
                                       register, validate_token)
...
from .views_visualitzarJardi import (garden_plants, user_gardens,
                                     user_products, user_seeds, water_plant)
